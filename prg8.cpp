...
// Refer AtoZMath.com for examples and reference
...
int main()
{
    ...
    */
    ...
    // double u = (1895.0 - 1891.0) / 10.0;
    double u = 0.4;

    double ans = mat[0][0] + u * mat[1][0] + (u * (u - 1) * mat[2][0]) / factorial(2) + (u * (u - 1) * (u - 2) * mat[3][0]) / factorial(3) + (u * (u - 1) * (u - 2) * (u - 3) * mat[4][0]) / factorial(4);
